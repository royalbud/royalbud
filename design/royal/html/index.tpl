            ...
            <div class="container">
                <div class="header__top">
                    ...
                    <div class="header__adress">
                        <span data-language="adress">{$lang->adress}</span>
                    </div>

                    {* Account *}
                    <div id="account" class="d-flex align-items-center f_col-auto">
        ...
        <div class="header__center" >
            <div class="container">
                <div class="f_row no_gutters flex-nowrap align-items-center justify-content-between">
                    ...
                    {if $language->label == 'ru'}
                        {$logo = 'royal-logo.svg'}
                    {else}
                        {$logo = 'royal-logo-ua.svg'}
                    {/if}

                    {* Logo *}
                    <div class="header__logo logo">
                        <a class="logo__link " href="{if $controller=='MainController'}javascript:;{else}{url_generator route='main'}{/if}">
                            <img src="{$rootUrl}/design/royal/images/{$logo}" alt="{$settings->site_name|escape}"/>
                        </a>
                    </div>
                    ...
                    <div class="header-right d-flex f_col-auto align-items-center">
                        {* header contacts *}
                ...
                <div class="container">
                    <div class="header__bottom_panel f_row no_gutters flex-nowrap align-content-stretch justify-content-between">
                        ...
                        <div class="header__logo logo">
                            ...
                            <a class="logo__link " href="{if $controller=='MainController'}javascript:;{else}{url_generator route='main'}{/if}">
                                <img src="{$rootUrl}/design/royal/images/royal-logo-white.svg" alt="{$settings->site_name|escape}"/>
                            </a>
                            {/if}
                        </div>
                        ...
                        <div class="header_informers d-flex align-items-center">
                            ...
                            <div class="fn_search_toggle header_informers__item d-flex align-items-center justify-content-center hidden-lg-up">{include file="svg.tpl" svgId="search_icon"}</div>
                            {* Wishlist informer 
                            ...
                            <div id="telephones" class="header_informers__item d-flex align-items-center justify-content-center">{include file="svg.tpl" svgId="phone_icon"}</div>
                            <script>
